...
public class YahooWeatherService implements WeatherServiceInterface {
    ...
    private static final Logger log = LoggerFactory
            .getLogger(YahooWeatherService.class);
    ...
    protected WeatherInfo parseWeather(InputStream in) {
		...
		/*
		 * Taken from sonatype.org, see above
		 */
        ...
        weather
                .setCondition(doc
                        .valueOf("/rss/channel/item/y:condition/@text"));
        weather.setTemperature(doc
                .valueOf("/rss/channel/item/y:condition/@temp"));
